...
IPGEOLOCATION_SETTINGS = {
    ...
    'BACKEND_API_KEY': '',  # Add your API key here if using a paid service
    'BACKEND_API': 'ipapi',  # Free service: ipapi, ip-api, ipstack, etc.
    'BACKEND_TIMEOUT': 5,  # Timeout in seconds
    'BACKEND_RETRY': 3,  # Number of retries
    'BACKEND_CACHE': True,  # Enable caching
    'BACKEND_CACHE_TIMEOUT': 86400,  # Cache for 24 hours (86400 seconds)
}
